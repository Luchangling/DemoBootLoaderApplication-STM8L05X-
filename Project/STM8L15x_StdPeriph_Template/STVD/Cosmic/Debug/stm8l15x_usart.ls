 ...
 459                     ; 229   USARTx->BRR2 = (uint8_t)((BaudRate_Mantissa >> (uint8_t)8) & (uint8_t)0xF0);
 461  003a 7b03          	ld	a,(OFST-1,sp)
 462  003c 1e05          	ldw	x,(OFST+1,sp)
 463  003e a4f0          	and	a,#240
 464  0040 e703          	ld	(3,x),a
 465                     ; 231   USARTx->BRR2 |= (uint8_t)(BaudRate_Mantissa & (uint8_t)0x0F);
 467  0042 7b04          	ld	a,(OFST+0,sp)
 468  0044 a40f          	and	a,#15
 469  0046 ea03          	or	a,(3,x)
 470  0048 e703          	ld	(3,x),a
 471                     ; 233   USARTx->BRR1 = (uint8_t)(BaudRate_Mantissa >> (uint8_t)4);
 473  004a 96            	ldw	x,sp
 474  004b 5c            	incw	x
 475  004c cd0000        	call	c_ltor
 477  004f a604          	ld	a,#4
 478  0051 cd0000        	call	c_lursh
 480  0054 1e05          	ldw	x,(OFST+1,sp)
 481  0056 b603          	ld	a,c_lreg+3
 482  0058 e702          	ld	(2,x),a
 483                     ; 236   USARTx->CR2 &= (uint8_t)~(USART_CR2_TEN | USART_CR2_REN);
 ...
 792  000b               L163:
 793                     ; 304     USARTx->CR1 |= USART_CR1_USARTD;  /**< USART Disable (for low power consumption) */
 ...
 803  0013 85            	popw	x
 804  0014 81            	ret	
 848                     ; 329 void USART_SetPrescaler(USART_TypeDef* USARTx, uint8_t USART_Prescaler)
 848                     ; 330 {
 849                     .text:	section	.text,new
 850  0000               _USART_SetPrescaler:
 852  0000 89            	pushw	x
 853       00000000      OFST:	set	0
 856                     ; 332   USARTx->PSCR = USART_Prescaler;
 858  0001 1e01          	ldw	x,(OFST+1,sp)
 859  0003 7b05          	ld	a,(OFST+5,sp)
 860  0005 e70a          	ld	(10,x),a
 861                     ; 333 }
 864  0007 85            	popw	x
 865  0008 81            	ret	
 902                     ; 340 void USART_SendBreak(USART_TypeDef* USARTx)
 902                     ; 341 {
 903                     .text:	section	.text,new
 904  0000               _USART_SendBreak:
 908                     ; 342   USARTx->CR2 |= USART_CR2_SBK;
 910  0000 e605          	ld	a,(5,x)
 911  0002 aa01          	or	a,#1
 912  0004 e705          	ld	(5,x),a
 913                     ; 343 }
 916  0006 81            	ret	
 953                     ; 382 uint8_t USART_ReceiveData8(USART_TypeDef* USARTx)
 953                     ; 383 {
 954                     .text:	section	.text,new
 955  0000               _USART_ReceiveData8:
 959                     ; 384   return USARTx->DR;
 961  0000 e601          	ld	a,(1,x)
 964  0002 81            	ret	
1008                     ; 392 uint16_t USART_ReceiveData9(USART_TypeDef* USARTx)
1008                     ; 393 {
...
1017                     ; 394   uint16_t temp = 0;
1019                     ; 396   temp = ((uint16_t)(((uint16_t)((uint16_t)USARTx->CR1 & (uint16_t)USART_CR1_R8)) << 1));
...
1042  001c 81            	ret	
1086                     ; 405 void USART_SendData8(USART_TypeDef* USARTx, uint8_t Data)
1086                     ; 406 {
1087                     .text:	section	.text,new
1088  0000               _USART_SendData8:
1090  0000 89            	pushw	x
1091       00000000      OFST:	set	0
1094                     ; 408   USARTx->DR = Data;
1096  0001 1e01          	ldw	x,(OFST+1,sp)
1097  0003 7b05          	ld	a,(OFST+5,sp)
1098  0005 e701          	ld	(1,x),a
1099                     ; 409 }
1102  0007 85            	popw	x
1103  0008 81            	ret	
1147                     ; 418 void USART_SendData9(USART_TypeDef* USARTx, uint16_t Data)
1147                     ; 419 {
1148                     .text:	section	.text,new
1149  0000               _USART_SendData9:
1151  0000 89            	pushw	x
1152       00000000      OFST:	set	0
1155                     ; 420   assert_param(IS_USART_DATA_9BITS(Data));
1157                     ; 423   USARTx->CR1 &= ((uint8_t)~USART_CR1_T8);
1159  0001 e604          	ld	a,(4,x)
1160  0003 a4bf          	and	a,#191
1161  0005 e704          	ld	(4,x),a
1162                     ; 426   USARTx->CR1 |= (uint8_t)(((uint8_t)(Data >> 2)) & USART_CR1_T8);
...
1171                     ; 429   USARTx->DR   = (uint8_t)(Data);
1173  0015 1e01          	ldw	x,(OFST+1,sp)
1174  0017 7b06          	ld	a,(OFST+6,sp)
1175  0019 e701          	ld	(1,x),a
1176                     ; 430 }
1179  001b 85            	popw	x
1180  001c 81            	ret	
1228                     ; 473 void USART_ReceiverWakeUpCmd(USART_TypeDef* USARTx, FunctionalState NewState)
1228                     ; 474 {
1229                     .text:	section	.text,new
1230  0000               _USART_ReceiverWakeUpCmd:
1232  0000 89            	pushw	x
1233       00000000      OFST:	set	0
1236                     ; 475   assert_param(IS_FUNCTIONAL_STATE(NewState));
1238                     ; 477   if (NewState != DISABLE)
1240  0001 7b05          	ld	a,(OFST+5,sp)
1241  0003 2706          	jreq	L165
1242                     ; 480     USARTx->CR2 |= USART_CR2_RWU;
1244  0005 e605          	ld	a,(5,x)
1245  0007 aa02          	or	a,#2
1247  0009 2006          	jra	L365
1248  000b               L165:
1249                     ; 485     USARTx->CR2 &= ((uint8_t)~USART_CR2_RWU);
...
1259  0013 85            	popw	x
1260  0014 81            	ret	
1304                     ; 496 void USART_SetAddress(USART_TypeDef* USARTx, uint8_t USART_Address)
1304                     ; 497 {
1305                     .text:	section	.text,new
1306  0000               _USART_SetAddress:
1308  0000 89            	pushw	x
1309       00000000      OFST:	set	0
1312                     ; 499   assert_param(IS_USART_ADDRESS(USART_Address));
1314                     ; 502   USARTx->CR4 &= ((uint8_t)~USART_CR4_ADD);
1316  0001 e607          	ld	a,(7,x)
1317  0003 a4f0          	and	a,#240
1318  0005 e707          	ld	(7,x),a
1319                     ; 504   USARTx->CR4 |= USART_Address;
...
1327  000d 85            	popw	x
1328  000e 81            	ret	
1397                     ; 515 void USART_WakeUpConfig(USART_TypeDef* USARTx, USART_WakeUp_TypeDef USART_WakeUp)
1397                     ; 516 {
1398                     .text:	section	.text,new
1399  0000               _USART_WakeUpConfig:
1401  0000 89            	pushw	x
1402       00000000      OFST:	set	0
1405                     ; 517   assert_param(IS_USART_WAKEUP(USART_WakeUp));
1407                     ; 519   USARTx->CR1 &= ((uint8_t)~USART_CR1_WAKE);
1409  0001 e604          	ld	a,(4,x)
1410  0003 a4f7          	and	a,#247
1411  0005 e704          	ld	(4,x),a
1412                     ; 520   USARTx->CR1 |= (uint8_t)USART_WakeUp;
...
1420  000d 85            	popw	x
1421  000e 81            	ret	
1469                     ; 566 void USART_HalfDuplexCmd(USART_TypeDef* USARTx, FunctionalState NewState)
1469                     ; 567 {
...
1479                     ; 570   if (NewState != DISABLE)
1481  0001 7b05          	ld	a,(OFST+5,sp)
1482  0003 2706          	jreq	L766
1483                     ; 572     USARTx->CR5 |= USART_CR5_HDSEL;  /**< USART Half Duplex Enable  */
1485  0005 e608          	ld	a,(8,x)
1486  0007 aa08          	or	a,#8
1488  0009 2006          	jra	L176
1489  000b               L766:
1490                     ; 576     USARTx->CR5 &= (uint8_t)~USART_CR5_HDSEL; /**< USART Half Duplex Disable */
...
1500  0013 85            	popw	x
1501  0014 81            	ret	
1548                     ; 644 void USART_SmartCardCmd(USART_TypeDef* USARTx, FunctionalState NewState)
1548                     ; 645 {
1549                     .text:	section	.text,new
1550  0000               _USART_SmartCardCmd:
1552  0000 89            	pushw	x
1553       00000000      OFST:	set	0
1556                     ; 646   assert_param(IS_FUNCTIONAL_STATE(NewState));
1558                     ; 648   if (NewState != DISABLE)
1560  0001 7b05          	ld	a,(OFST+5,sp)
1561  0003 2706          	jreq	L717
1562                     ; 651     USARTx->CR5 |= USART_CR5_SCEN;
1564  0005 e608          	ld	a,(8,x)
1565  0007 aa20          	or	a,#32
1567  0009 2006          	jra	L127
1568  000b               L717:
1569                     ; 656     USARTx->CR5 &= ((uint8_t)(~USART_CR5_SCEN));
...
1579  0013 85            	popw	x
1580  0014 81            	ret	
1628                     ; 667 void USART_SmartCardNACKCmd(USART_TypeDef* USARTx, FunctionalState NewState)
1628                     ; 668 {
1629                     .text:	section	.text,new
1630  0000               _USART_SmartCardNACKCmd:
1632  0000 89            	pushw	x
1633       00000000      OFST:	set	0
1636                     ; 669   assert_param(IS_FUNCTIONAL_STATE(NewState));
1638                     ; 671   if (NewState != DISABLE)
1640  0001 7b05          	ld	a,(OFST+5,sp)
1641  0003 2706          	jreq	L747
1642                     ; 674     USARTx->CR5 |= USART_CR5_NACK;
1644  0005 e608          	ld	a,(8,x)
1645  0007 aa10          	or	a,#16
1647  0009 2006          	jra	L157
1648  000b               L747:
1649                     ; 679     USARTx->CR5 &= ((uint8_t)~(USART_CR5_NACK));
...
1659  0013 85            	popw	x
1660  0014 81            	ret	
1704                     ; 690 void USART_SetGuardTime(USART_TypeDef* USARTx, uint8_t USART_GuardTime)
1704                     ; 691 {
1705                     .text:	section	.text,new
1706  0000               _USART_SetGuardTime:
1708  0000 89            	pushw	x
1709       00000000      OFST:	set	0
1712                     ; 693   USARTx->GTR = USART_GuardTime;
1714  0001 1e01          	ldw	x,(OFST+1,sp)
1715  0003 7b05          	ld	a,(OFST+5,sp)
1716  0005 e709          	ld	(9,x),a
1717                     ; 694 }
1720  0007 85            	popw	x
1721  0008 81            	ret	
1790                     ; 751 void USART_IrDAConfig(USART_TypeDef* USARTx, USART_IrDAMode_TypeDef USART_IrDAMode)
1790                     ; 752 {
1791                     .text:	section	.text,new
1792  0000               _USART_IrDAConfig:
1794  0000 89            	pushw	x
1795       00000000      OFST:	set	0
1798                     ; 753   assert_param(IS_USART_IRDAMODE(USART_IrDAMode));
1800                     ; 755   if (USART_IrDAMode != USART_IrDAMode_Normal)
1802  0001 7b05          	ld	a,(OFST+5,sp)
1803  0003 2706          	jreq	L1301
1804                     ; 757     USARTx->CR5 |= USART_CR5_IRLP;
1806  0005 e608          	ld	a,(8,x)
1807  0007 aa04          	or	a,#4
1809  0009 2006          	jra	L3301
1810  000b               L1301:
1811                     ; 761     USARTx->CR5 &= ((uint8_t)~USART_CR5_IRLP);
...
1821  0013 85            	popw	x
1822  0014 81            	ret	
1869                     ; 772 void USART_IrDACmd(USART_TypeDef* USARTx, FunctionalState NewState)
1869                     ; 773 {
1870                     .text:	section	.text,new
1871  0000               _USART_IrDACmd:
1873  0000 89            	pushw	x
1874       00000000      OFST:	set	0
1877                     ; 776   assert_param(IS_FUNCTIONAL_STATE(NewState));
1879                     ; 778   if (NewState != DISABLE)
1881  0001 7b05          	ld	a,(OFST+5,sp)
1882  0003 2706          	jreq	L1601
1883                     ; 781     USARTx->CR5 |= USART_CR5_IREN;
1885  0005 e608          	ld	a,(8,x)
1886  0007 aa02          	or	a,#2
1888  0009 2006          	jra	L3601
1889  000b               L1601:
1890                     ; 786     USARTx->CR5 &= ((uint8_t)~USART_CR5_IREN);
...
1900  0013 85            	popw	x
1901  0014 81            	ret	
1978                     ; 818 void USART_DMACmd(USART_TypeDef* USARTx, USART_DMAReq_TypeDef USART_DMAReq,
1978                     ; 819                   FunctionalState NewState)
1978                     ; 820 {
1979                     .text:	section	.text,new
1980  0000               _USART_DMACmd:
1982  0000 89            	pushw	x
1983       00000000      OFST:	set	0
1986                     ; 822   assert_param(IS_USART_DMAREQ(USART_DMAReq));
1988                     ; 823   assert_param(IS_FUNCTIONAL_STATE(NewState));
1990                     ; 825   if (NewState != DISABLE)
1992  0001 7b06          	ld	a,(OFST+6,sp)
1993  0003 2706          	jreq	L5211
1994                     ; 829     USARTx->CR5 |= (uint8_t) USART_DMAReq;
1996  0005 e608          	ld	a,(8,x)
1997  0007 1a05          	or	a,(OFST+5,sp)
1999  0009 2007          	jra	L7211
2000  000b               L5211:
2001                     ; 835     USARTx->CR5 &= (uint8_t)~USART_DMAReq;
...
2012  0014 85            	popw	x
2013  0015 81            	ret	
2153                     ; 939 void USART_ITConfig(USART_TypeDef* USARTx, USART_IT_TypeDef USART_IT, FunctionalState NewState)
2153                     ; 940 {
...
2162                     ; 941   uint8_t usartreg, itpos = 0x00;
2164                     ; 942   assert_param(IS_USART_CONFIG_IT(USART_IT));
2166                     ; 943   assert_param(IS_FUNCTIONAL_STATE(NewState));
2168                     ; 946   usartreg = (uint8_t)((uint16_t)USART_IT >> 0x08);
2170  0002 7b07          	ld	a,(OFST+5,sp)
2171  0004 6b01          	ld	(OFST-1,sp),a
2172                     ; 948   itpos = (uint8_t)((uint8_t)1 << (uint8_t)((uint8_t)USART_IT & (uint8_t)0x0F));
...
2238  004e               L7221:
2239                     ; 974     else if (usartreg == 0x05)
2241  004e a105          	cp	a,#5
2242  0050 260b          	jrne	L3321
2243                     ; 976       USARTx->CR5 &= (uint8_t)(~itpos);
...
2253  005d               L3321:
2254                     ; 981       USARTx->CR2 &= (uint8_t)(~itpos);
...
2267  0068 81            	ret	
2415                     ; 1002 FlagStatus USART_GetFlagStatus(USART_TypeDef* USARTx, USART_FLAG_TypeDef USART_FLAG)
2415                     ; 1003 {
...
2424                     ; 1004   FlagStatus status = RESET;
2426                     ; 1007   assert_param(IS_USART_FLAG(USART_FLAG));
2428                     ; 1009   if (USART_FLAG == USART_FLAG_SBK)
2430  0002 1e06          	ldw	x,(OFST+5,sp)
2431  0004 a30101        	cpw	x,#257
2432  0007 260a          	jrne	L5231
2433                     ; 1011     if ((USARTx->CR2 & (uint8_t)USART_FLAG) != (uint8_t)0x00)
2435  0009 1e02          	ldw	x,(OFST+1,sp)
2436  000b e605          	ld	a,(5,x)
2437  000d 1507          	bcp	a,(OFST+6,sp)
2438  000f 270d          	jreq	L5331
2439                     ; 1014       status = SET;
2441  0011 2007          	jp	LC005
2442                     ; 1019       status = RESET;
2443  0013               L5231:
2444                     ; 1024     if ((USARTx->SR & (uint8_t)USART_FLAG) != (uint8_t)0x00)
2446  0013 1e02          	ldw	x,(OFST+1,sp)
2447  0015 f6            	ld	a,(x)
2448  0016 1507          	bcp	a,(OFST+6,sp)
2449  0018 2704          	jreq	L5331
2450                     ; 1027       status = SET;
2452  001a               LC005:
2454  001a a601          	ld	a,#1
2456  001c 2001          	jra	L3331
2457  001e               L5331:
2458                     ; 1032       status = RESET;
2461  001e 4f            	clr	a
2462  001f               L3331:
2463                     ; 1036   return status;
2467  001f 5b03          	addw	sp,#3
2468  0021 81            	ret	
2515                     ; 1060 void USART_ClearFlag(USART_TypeDef* USARTx, USART_FLAG_TypeDef USART_FLAG)
2515                     ; 1061 {
2516                     .text:	section	.text,new
2517  0000               _USART_ClearFlag:
2519  0000 89            	pushw	x
2520       00000000      OFST:	set	0
2523                     ; 1063   assert_param(IS_USART_CLEAR_FLAG(USART_FLAG));
2525                     ; 1065   USARTx->SR = (uint8_t)((uint16_t)~((uint16_t)USART_FLAG));
2527  0001 7b06          	ld	a,(OFST+6,sp)
2528  0003 1e01          	ldw	x,(OFST+1,sp)
2529  0005 43            	cpl	a
2530  0006 f7            	ld	(x),a
2531                     ; 1066 }
2534  0007 85            	popw	x
2535  0008 81            	ret	
2628                     ; 1083 ITStatus USART_GetITStatus(USART_TypeDef* USARTx, USART_IT_TypeDef USART_IT)
2628                     ; 1084 {
...
2637                     ; 1085   ITStatus pendingbitstatus = RESET;
2639                     ; 1086   uint8_t temp = 0;
2641                     ; 1087   uint8_t itpos = 0;
2643                     ; 1088   uint8_t itmask1 = 0;
2645                     ; 1089   uint8_t itmask2 = 0;
2647                     ; 1090   uint8_t enablestatus = 0;
2649                     ; 1093   assert_param(IS_USART_GET_IT(USART_IT));
2651                     ; 1096   itpos = (uint8_t)((uint8_t)1 << (uint8_t)((uint8_t)USART_IT & (uint8_t)0x0F));
...
2666                     ; 1098   itmask1 = (uint8_t)((uint8_t)USART_IT >> (uint8_t)4);
2668  0014 7b09          	ld	a,(OFST+6,sp)
2669  0016 4e            	swap	a
2670  0017 a40f          	and	a,#15
2671  0019 6b03          	ld	(OFST+0,sp),a
2672                     ; 1100   itmask2 = (uint8_t)((uint8_t)1 << itmask1);
2674  001b 5f            	clrw	x
...
2735  0060               L3441:
2736                     ; 1132       pendingbitstatus = SET;
2740  0060 a601          	ld	a,#1
2742  0062 2012          	jra	L5341
2743                     ; 1137       pendingbitstatus = RESET;
2744  0064               L7341:
2745                     ; 1144     enablestatus = (uint8_t)((uint8_t)USARTx->CR2 & itmask2);
2747  0064 1e04          	ldw	x,(OFST+1,sp)
2748  0066 e605          	ld	a,(5,x)
2749  0068 1403          	and	a,(OFST+0,sp)
2750  006a 6b03          	ld	(OFST+0,sp),a
2751                     ; 1146     if (((USARTx->SR & itpos) != (uint8_t)0x00) && enablestatus)
2753  006c f6            	ld	a,(x)
2754  006d 1502          	bcp	a,(OFST-1,sp)
2755  006f 2704          	jreq	L1541
2757  0071 7b03          	ld	a,(OFST+0,sp)
2758                     ; 1149       pendingbitstatus = SET;
2760  0073 26eb          	jrne	L3441
2761  0075               L1541:
2762                     ; 1154       pendingbitstatus = RESET;
2766  0075 4f            	clr	a
2767  0076               L5341:
2768                     ; 1159   return  pendingbitstatus;
2772  0076 5b05          	addw	sp,#5
2773  0078 81            	ret	
2811                     ; 1183 void USART_ClearITPendingBit(USART_TypeDef* USARTx, USART_IT_TypeDef USART_IT)
2811                     ; 1184 {
2812                     .text:	section	.text,new
2813  0000               _USART_ClearITPendingBit:
2817                     ; 1185   assert_param(IS_USART_CLEAR_IT(USART_IT));
2819                     ; 1188   USARTx->SR &= (uint8_t)(~USART_SR_TC);
2821  0000 f6            	ld	a,(x)
