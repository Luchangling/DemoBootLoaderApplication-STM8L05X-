 ...
 526  000c 1e02          	ldw	x,(OFST+1,sp)
 527  000e 1a01          	or	a,(OFST+0,sp)
 528  0010 f7            	ld	(x),a
 529                     ; 200   SPIx->CR2 = (uint8_t)((uint8_t)(SPI_Data_Direction) | (uint8_t)(SPI_Slave_Management));
 531  0011 7b0b          	ld	a,(OFST+10,sp)
 532  0013 1a0c          	or	a,(OFST+11,sp)
 533  0015 e701          	ld	(1,x),a
 534                     ; 202   if (SPI_Mode == SPI_Mode_Master)
 536  0017 7b08          	ld	a,(OFST+7,sp)
 537  0019 a104          	cp	a,#4
 538  001b 2606          	jrne	L362
 539                     ; 204     SPIx->CR2 |= (uint8_t)SPI_CR2_SSI;
 541  001d e601          	ld	a,(1,x)
 542  001f aa01          	or	a,#1
 544  0021 2004          	jra	L562
 545  0023               L362:
 546                     ; 208     SPIx->CR2 &= (uint8_t)~(SPI_CR2_SSI);
 ...
 732  000b               L353:
 733                     ; 258     SPIx->CR2 &= (uint8_t)(~SPI_CR2_SSI); /* Reset NSS pin internally by software*/
 ...
 743  0013 85            	popw	x
 744  0014 81            	ret	
 812                     ; 271 void SPI_BiDirectionalLineConfig(SPI_TypeDef* SPIx, SPI_Direction_TypeDef SPI_Direction)
 812                     ; 272 {
 813                     .text:	section	.text,new
 814  0000               _SPI_BiDirectionalLineConfig:
 816  0000 89            	pushw	x
 817       00000000      OFST:	set	0
 820                     ; 274   assert_param(IS_SPI_DIRECTION(SPI_Direction));
 822                     ; 276   if (SPI_Direction != SPI_Direction_Rx)
 824  0001 7b05          	ld	a,(OFST+5,sp)
 825  0003 2706          	jreq	L314
 826                     ; 278     SPIx->CR2 |= SPI_CR2_BDOE; /* Set the Tx only mode*/
 828  0005 e601          	ld	a,(1,x)
 829  0007 aa40          	or	a,#64
 831  0009 2006          	jra	L514
 832  000b               L314:
 833                     ; 282     SPIx->CR2 &= (uint8_t)(~SPI_CR2_BDOE); /* Set the Rx only mode*/
 ...
 843  0013 85            	popw	x
 844  0014 81            	ret	
 888                     ; 319 void SPI_SendData(SPI_TypeDef* SPIx, uint8_t Data)
 888                     ; 320 {
 889                     .text:	section	.text,new
 890  0000               _SPI_SendData:
 892  0000 89            	pushw	x
 893       00000000      OFST:	set	0
 896                     ; 321   SPIx->DR = Data; /* Write in the DR register the data to be sent*/
 898  0001 1e01          	ldw	x,(OFST+1,sp)
 899  0003 7b05          	ld	a,(OFST+5,sp)
 900  0005 e704          	ld	(4,x),a
 901                     ; 322 }
 904  0007 85            	popw	x
 905  0008 81            	ret	
 942                     ; 329 uint8_t SPI_ReceiveData(SPI_TypeDef* SPIx)
 942                     ; 330 {
 943                     .text:	section	.text,new
 944  0000               _SPI_ReceiveData:
 948                     ; 331   return ((uint8_t)SPIx->DR); /* Return the data in the DR register*/
 950  0000 e604          	ld	a,(4,x)
 953  0002 81            	ret	
 990                     ; 414 void SPI_TransmitCRC(SPI_TypeDef* SPIx)
 990                     ; 415 {
 991                     .text:	section	.text,new
 992  0000               _SPI_TransmitCRC:
 996                     ; 416   SPIx->CR2 |= SPI_CR2_CRCNEXT; /* Enable the CRC transmission*/
 998  0000 e601          	ld	a,(1,x)
 999  0002 aa10          	or	a,#16
1000  0004 e701          	ld	(1,x),a
1001                     ; 417 }
1004  0006 81            	ret	
1053                     ; 426 void SPI_CalculateCRCCmd(SPI_TypeDef* SPIx, FunctionalState NewState)
1053                     ; 427 {
1054                     .text:	section	.text,new
1055  0000               _SPI_CalculateCRCCmd:
1057  0000 89            	pushw	x
1058       00000000      OFST:	set	0
1061                     ; 429   assert_param(IS_FUNCTIONAL_STATE(NewState));
1063                     ; 432   SPI_Cmd(SPI1, DISABLE);
1065  0001 4b00          	push	#0
1066  0003 ae5200        	ldw	x,#20992
1067  0006 cd0000        	call	_SPI_Cmd
1069  0009 84            	pop	a
1070                     ; 434   if (NewState != DISABLE)
1072  000a 7b05          	ld	a,(OFST+5,sp)
1073  000c 2708          	jreq	L525
1074                     ; 436     SPIx->CR2 |= SPI_CR2_CRCEN; /* Enable the CRC calculation*/
1076  000e 1e01          	ldw	x,(OFST+1,sp)
1077  0010 e601          	ld	a,(1,x)
1078  0012 aa20          	or	a,#32
1080  0014 2006          	jra	L725
1081  0016               L525:
1082                     ; 440     SPIx->CR2 &= (uint8_t)(~SPI_CR2_CRCEN); /* Disable the CRC calculation*/
...
1092  001e 85            	popw	x
1093  001f 81            	ret	
1167                     ; 453 uint8_t SPI_GetCRC(SPI_TypeDef* SPIx, SPI_CRC_TypeDef SPI_CRC)
1167                     ; 454 {
...
1263  000f 85            	popw	x
1264  0010 81            	ret	
1302                     ; 493 uint8_t SPI_GetCRCPolynomial(SPI_TypeDef* SPIx)
1302                     ; 494 {
1303                     .text:	section	.text,new
1304  0000               _SPI_GetCRCPolynomial:
1308                     ; 495   return SPIx->CRCPR; /* Return the CRC polynomial register */
1310  0000 e605          	ld	a,(5,x)
1313  0002 81            	ret	
1390                     ; 525 void SPI_DMACmd(SPI_TypeDef* SPIx, SPI_DMAReq_TypeDef SPI_DMAReq, FunctionalState NewState)
1390                     ; 526 {
1391                     .text:	section	.text,new
1392  0000               _SPI_DMACmd:
1394  0000 89            	pushw	x
1395       00000000      OFST:	set	0
1398                     ; 528   assert_param(IS_FUNCTIONAL_STATE(NewState));
1400                     ; 529   assert_param(IS_SPI_DMAREQ(SPI_DMAReq));
1402                     ; 531   if (NewState != DISABLE)
1404  0001 7b06          	ld	a,(OFST+6,sp)
1405  0003 2706          	jreq	L376
1406                     ; 534     SPIx->CR3 |= (uint8_t) SPI_DMAReq;
1408  0005 e602          	ld	a,(2,x)
1409  0007 1a05          	or	a,(OFST+5,sp)
1411  0009 2007          	jra	L576
1412  000b               L376:
1413                     ; 539     SPIx->CR3 &= (uint8_t)~SPI_DMAReq;
...
1424  0014 85            	popw	x
1425  0015 81            	ret	
1544                     ; 626 void SPI_ITConfig(SPI_TypeDef* SPIx, SPI_IT_TypeDef SPI_IT, FunctionalState NewState)
1544                     ; 627 {
...
1553                     ; 628   uint8_t itpos = 0;
1555                     ; 630   assert_param(IS_SPI_CONFIG_IT(SPI_IT));
1557                     ; 631   assert_param(IS_FUNCTIONAL_STATE(NewState));
1559                     ; 634   itpos = (uint8_t)((uint8_t)1 << (uint8_t)((uint8_t)SPI_IT & (uint8_t)0x0F));
...
1597  0028 81            	ret	
1730                     ; 661 FlagStatus SPI_GetFlagStatus(SPI_TypeDef* SPIx, SPI_FLAG_TypeDef SPI_FLAG)
1730                     ; 662 {
...
1739                     ; 663   FlagStatus status = RESET;
1741                     ; 665   assert_param(IS_SPI_FLAG(SPI_FLAG));
1743                     ; 668   if ((SPIx->SR & (uint8_t)SPI_FLAG) != (uint8_t)RESET)
1745  0002 e603          	ld	a,(3,x)
1746  0004 1506          	bcp	a,(OFST+5,sp)
1747  0006 2704          	jreq	L1401
1748                     ; 670     status = SET; /* SPI_FLAG is set */
1750  0008 a601          	ld	a,#1
1752  000a 2001          	jra	L3401
1753  000c               L1401:
1754                     ; 674     status = RESET; /* SPI_FLAG is reset*/
1756  000c 4f            	clr	a
1757  000d               L3401:
1758                     ; 678   return status;
1762  000d 5b03          	addw	sp,#3
1763  000f 81            	ret	
1810                     ; 696 void SPI_ClearFlag(SPI_TypeDef* SPIx, SPI_FLAG_TypeDef SPI_FLAG)
1810                     ; 697 {
1811                     .text:	section	.text,new
1812  0000               _SPI_ClearFlag:
1814  0000 89            	pushw	x
1815       00000000      OFST:	set	0
1818                     ; 698   assert_param(IS_SPI_CLEAR_FLAG(SPI_FLAG));
1820                     ; 700   SPIx->SR = (uint8_t)(~SPI_FLAG);
1822  0001 7b05          	ld	a,(OFST+5,sp)
1823  0003 1e01          	ldw	x,(OFST+1,sp)
1824  0005 43            	cpl	a
...
2003  0043 81            	ret	
2058                     ; 764 void SPI_ClearITPendingBit(SPI_TypeDef* SPIx, SPI_IT_TypeDef SPI_IT)
2058                     ; 765 {
...
2067                     ; 766   uint8_t itpos = 0;
2069                     ; 767   assert_param(IS_SPI_CLEAR_IT(SPI_IT));
2071                     ; 772   itpos = (uint8_t)((uint8_t)1 << (uint8_t)((uint8_t)(SPI_IT & (uint8_t)0xF0) >> 4));
...
2087                     ; 774   SPIx->SR = (uint8_t)(~itpos);
2089  0014 1e02          	ldw	x,(OFST+1,sp)
2090  0016 43            	cpl	a
