 ...
 379  004c               L751:
 380                     ; 187     GPIOx->CR2 &= (uint8_t)(~(GPIO_Pin));
 ...
 390  0053 85            	popw	x
 391  0054 81            	ret	
 466                     ; 209 void GPIO_ExternalPullUpConfig(GPIO_TypeDef* GPIOx, uint8_t GPIO_Pin, FunctionalState NewState)
 466                     ; 210 {
 467                     .text:	section	.text,new
 468  0000               _GPIO_ExternalPullUpConfig:
 470  0000 89            	pushw	x
 471       00000000      OFST:	set	0
 474                     ; 212   assert_param(IS_GPIO_PIN(GPIO_Pin));
 476                     ; 213   assert_param(IS_FUNCTIONAL_STATE(NewState));
 478                     ; 215   if (NewState != DISABLE) /* External Pull-Up Set*/
 480  0001 7b06          	ld	a,(OFST+6,sp)
 481  0003 2706          	jreq	L122
 482                     ; 217     GPIOx->CR1 |= GPIO_Pin;
 484  0005 e603          	ld	a,(3,x)
 485  0007 1a05          	or	a,(OFST+5,sp)
 487  0009 2007          	jra	L322
 488  000b               L122:
 489                     ; 220     GPIOx->CR1 &= (uint8_t)(~(GPIO_Pin));
 ...
 500  0014 85            	popw	x
 501  0015 81            	ret	
 545                     ; 248 void GPIO_Write(GPIO_TypeDef* GPIOx, uint8_t GPIO_PortVal)
 545                     ; 249 {
 546                     .text:	section	.text,new
 547  0000               _GPIO_Write:
 549  0000 89            	pushw	x
 550       00000000      OFST:	set	0
 553                     ; 250   GPIOx->ODR = GPIO_PortVal;
 555  0001 1e01          	ldw	x,(OFST+1,sp)
 556  0003 7b05          	ld	a,(OFST+5,sp)
 557  0005 f7            	ld	(x),a
 558                     ; 251 }
 561  0006 85            	popw	x
 562  0007 81            	ret	
 722                     ; 270 void GPIO_WriteBit(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef GPIO_Pin, BitAction GPIO_BitVal)
 722                     ; 271 {
 723                     .text:	section	.text,new
 724  0000               _GPIO_WriteBit:
 726  0000 89            	pushw	x
 727       00000000      OFST:	set	0
 730                     ; 273   assert_param(IS_GPIO_PIN(GPIO_Pin));
 732                     ; 274   assert_param(IS_STATE_VALUE(GPIO_BitVal));
 734                     ; 276   if (GPIO_BitVal != RESET)
 736  0001 7b06          	ld	a,(OFST+6,sp)
 737  0003 2705          	jreq	L143
 738                     ; 278     GPIOx->ODR |= GPIO_Pin;
 740  0005 f6            	ld	a,(x)
 ...
 756  0011 85            	popw	x
 757  0012 81            	ret	
 801                     ; 303 void GPIO_SetBits(GPIO_TypeDef* GPIOx, uint8_t GPIO_Pin)
 801                     ; 304 {
 802                     .text:	section	.text,new
 803  0000               _GPIO_SetBits:
 805  0000 89            	pushw	x
 806       00000000      OFST:	set	0
 809                     ; 305   GPIOx->ODR |= GPIO_Pin;
 811  0001 f6            	ld	a,(x)
 ...
 817  0005 85            	popw	x
 818  0006 81            	ret	
 862                     ; 324 void GPIO_ResetBits(GPIO_TypeDef* GPIOx, uint8_t GPIO_Pin)
 862                     ; 325 {
 863                     .text:	section	.text,new
 864  0000               _GPIO_ResetBits:
 866  0000 89            	pushw	x
 867       00000000      OFST:	set	0
 870                     ; 326   GPIOx->ODR &= (uint8_t)(~GPIO_Pin);
 ...
 879  0006 85            	popw	x
 880  0007 81            	ret	
 924                     ; 336 void GPIO_ToggleBits(GPIO_TypeDef* GPIOx, uint8_t GPIO_Pin)
 924                     ; 337 {
 925                     .text:	section	.text,new
 926  0000               _GPIO_ToggleBits:
 928  0000 89            	pushw	x
 929       00000000      OFST:	set	0
 932                     ; 338   GPIOx->ODR ^= GPIO_Pin;
 934  0001 f6            	ld	a,(x)
 ...
 940  0005 85            	popw	x
 941  0006 81            	ret	
 978                     ; 347 uint8_t GPIO_ReadInputData(GPIO_TypeDef* GPIOx)
 978                     ; 348 {
 979                     .text:	section	.text,new
 980  0000               _GPIO_ReadInputData:
 984                     ; 349   return ((uint8_t)GPIOx->IDR);
 986  0000 e601          	ld	a,(1,x)
 989  0002 81            	ret	
1027                     ; 358 uint8_t GPIO_ReadOutputData(GPIO_TypeDef* GPIOx)
1027                     ; 359 {
1028                     .text:	section	.text,new
1029  0000               _GPIO_ReadOutputData:
1033                     ; 360   return ((uint8_t)GPIOx->ODR);
1035  0000 f6            	ld	a,(x)
1038  0001 81            	ret	
1087                     ; 378 BitStatus GPIO_ReadInputDataBit(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef GPIO_Pin)
1087                     ; 379 {
1088                     .text:	section	.text,new
1089  0000               _GPIO_ReadInputDataBit:
1091  0000 89            	pushw	x
1092       00000000      OFST:	set	0
1095                     ; 380   return ((BitStatus)(GPIOx->IDR & (uint8_t)GPIO_Pin));
1097  0001 e601          	ld	a,(1,x)
1098  0003 1405          	and	a,(OFST+5,sp)
1101  0005 85            	popw	x
1102  0006 81            	ret	
1151                     ; 389 BitStatus GPIO_ReadOutputDataBit(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef GPIO_Pin)
1151                     ; 390 {
1152                     .text:	section	.text,new
1153  0000               _GPIO_ReadOutputDataBit:
1155  0000 89            	pushw	x
1156       00000000      OFST:	set	0
1159                     ; 391   return ((BitStatus)(GPIOx->ODR & (uint8_t)GPIO_Pin));
1161  0001 f6            	ld	a,(x)
