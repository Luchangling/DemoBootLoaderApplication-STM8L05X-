 ...
 413                     ; 151   if (NewState != DISABLE)
 415  0005 0d06          	tnz	(OFST+5,sp)
 416  0007 2730          	jreq	L302
 417                     ; 153     switch (register_index)
 420                     ; 171       default:
 420                     ; 172         break;
 421  0009 4a            	dec	a
 ...
 430  0017               L12:
 431                     ; 155       case 1:
 431                     ; 156         WFE->CR1 |= (uint8_t)WFE_Source;
 ...
 438  001e               L32:
 439                     ; 159       case 2:
 439                     ; 160         WFE->CR2 |= (uint8_t)WFE_Source;
 ...
 447  0028               L52:
 448                     ; 163       case 3:
 448                     ; 164         WFE->CR3 |= (uint8_t)WFE_Source;
 ...
 456  0032               L72:
 457                     ; 167       case 4:
 457                     ; 168         WFE->CR4 |= (uint8_t)WFE_Source;
 ...
 481  0047               L33:
 482                     ; 179       case 1:
 482                     ; 180         WFE->CR1 &= (uint8_t)(~(uint8_t)WFE_Source);
 ...
 527                     ; 195       default:
 527                     ; 196         break;
 575                     ; 237 FunctionalState WFE_GetWakeUpSourceEventStatus(WFE_Source_TypeDef WFE_Source)
 575                     ; 238 {
 ...
 584                     ; 239   FunctionalState status = DISABLE;
 586  0002 0f01          	clr	(OFST+0,sp)
 587                     ; 241   assert_param(IS_WFE_SOURCE(WFE_Source));
 589                     ; 243   switch (WFE_Source)
 592                     ; 326     default:
 592                     ; 327       break;
 ...
 656  009c               L712:
 657                     ; 245     case WFE_Source_TIM2_EV0:
 657                     ; 246     case WFE_Source_TIM2_EV1:
 657                     ; 247     case WFE_Source_TIM1_EV0:
 657                     ; 248     case WFE_Source_TIM1_EV1:
 657                     ; 249     case WFE_Source_EXTI_EV0:
 657                     ; 250     case WFE_Source_EXTI_EV1:
 657                     ; 251     case WFE_Source_EXTI_EV2:
 657                     ; 252     case WFE_Source_EXTI_EV3:
 657                     ; 253 
 657                     ; 254       if ((WFE->CR1 & (uint8_t)WFE_Source) != (uint8_t)0x00)
 659  009c c650a6        	ld	a,20646
 660                     ; 257         status = ENABLE;
 662  009f 2008          	jp	LC005
 663                     ; 262         status = DISABLE;
 664  00a1               L122:
 665                     ; 266     case WFE_Source_EXTI_EV4:
 665                     ; 267     case WFE_Source_EXTI_EV5:
 665                     ; 268     case WFE_Source_EXTI_EV6:
 665                     ; 269     case WFE_Source_EXTI_EV7:
 665                     ; 270     case WFE_Source_EXTI_EVB_G:
 665                     ; 271     case WFE_Source_EXTI_EVD_H:
 665                     ; 272     case WFE_Source_EXTI_EVE_F:
 665                     ; 273     case WFE_Source_ADC1_COMP_EV:
 665                     ; 274 
 665                     ; 275       if ((WFE->CR2 & (uint8_t)WFE_Source) != (uint8_t)0x00)
 667  00a1 c650a7        	ld	a,20647
 668                     ; 278         status = ENABLE;
 670  00a4 2003          	jp	LC005
 671                     ; 283         status = DISABLE;
 672  00a6               L322:
 673                     ; 286     case WFE_Source_TIM3_EV0:
 673                     ; 287     case WFE_Source_TIM3_EV1:
 673                     ; 288     case WFE_Source_TIM4_EV:
 673                     ; 289     case WFE_Source_SPI1_EV:
 673                     ; 290     case WFE_Source_I2C1_EV:
 673                     ; 291     case WFE_Source_USART1_EV:
 673                     ; 292     case WFE_Source_DMA1CH01_EV:
 673                     ; 293     case WFE_Source_DMA1CH23_EV:
 673                     ; 294 
 673                     ; 295       if ((WFE->CR3 & (uint8_t)WFE_Source) != (uint8_t)0x00)
 675  00a6 c650a8        	ld	a,20648
 676  00a9               LC005:
 677  00a9 1503          	bcp	a,(OFST+2,sp)
 678  00ab 270d          	jreq	L372
 679                     ; 298         status = ENABLE;
 681  00ad               LC004:
